...
// ✅ Proper image import (bundler-safe)
    ...
    <>
      <section className="paper-hero">
        <div className="paper-hero-text">
          <h1>Hi, I&apos;m Sachin.</h1>
          <p>
            I live at the intersection of code, creativity, and intelligence.
            From playful UIs to data-driven builds, I turn ideas into
            human-feeling products. This page is drawn to feel like a notebook
          ...
          <div className="paper-cta-row">
            ...
            <Link className="paper-cta alt" to="/blog">
              Read My Blog
            </Link>
            <Link
              className="paper-cta"
        ...
        <div className="paper-portrait">
          <img src={profileImage} alt="Sachin Khatri" />
        </div>
      </section>
      ...
      <section className="paper-social">
        ...
        <div className="paper-social-icons">
          ...
          <a
            href="https://github.com/sach1nkhatri"
            target="_blank"
            rel="noreferrer"
          >
            gh
          ...
          <a
            href="https://www.youtube.com/@SachinKhatri"
            target="_blank"
            rel="noreferrer"
          >
            yt
